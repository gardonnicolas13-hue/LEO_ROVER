...
40 & \textbf{A live UART checksum storm, unresolved} (\S\ref{sec:aug11mins}).
    ...
    throughout tonight's, ruling that specific mechanism out &
    repeat the July 30 protocol (Eq.~\ref{eq:missprob}: overrun count
    against a fixed window) with the rover stationary versus actively
    driven, to test the session's leading, unproven hypothesis that motion
    itself, not temperature, is exciting the UART link tonight \\
\end{longtable}
\end{center}
